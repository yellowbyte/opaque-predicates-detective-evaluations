...
{ 
  ...
  randomFuns_n25 = (_1entropy - ((_1entropy + _1entropy) & (_1entropy >> 63L))) + 9;
  ...
  while (1) {
    ...
    if ((((_1alwaysZero & ((_1entropy ^ 5) + ((_1entropy & 5) << 1L))) * (_1alwaysZero | ((_1entropy ^ 5) + ((_1entropy & 5) << 1L))) + (_1alwaysZero & ~ ((_1entropy ^ 5) + ((_1entropy & 5) << 1L))) * (~ _1alwaysZero & ((_1entropy ^ 5) + ((_1entropy & 5) << 1L)))) - ~ 0) - 1L) {
      __asm__  volatile   (".byte 0x80,0xb3,0x4f,0xea,0x46":);
    } else {
      break;
    }
    {
    if ((((_1alwaysZero & (((_1entropy + 4) + 1L) + ((- _1entropy - 1L) | (- 4 - 1L)))) * (_1alwaysZero | (((_1entropy + 4) + 1L) + ((- _1entropy - 1L) | (- 4 - 1L)))) + (_1alwaysZero & ~ (((_1entropy + 4) + 1L) + ((- _1entropy - 1L) | (- 4 - 1L)))) * (~ _1alwaysZero & (((_1entropy + 4) + 1L) + ((- _1entropy - 1L) | (- 4 - 1L))))) ^ 1) + ((((_1alwaysZero & (((_1entropy + 4) + 1L) + ((- _1entropy - 1L) | (- 4 - 1L)))) * (_1alwaysZero | (((_1entropy + 4) + 1L) + ((- _1entropy - 1L) | (- 4 - 1L)))) + (_1alwaysZero & ~ (((_1entropy + 4) + 1L) + ((- _1entropy - 1L) | (- 4 - 1L)))) * (~ _1alwaysZero & (((_1entropy + 4) + 1L) + ((- _1entropy - 1L) | (- 4 - 1L))))) & 1) << 1L)) {
      if ((((_1alwaysZero & ((_1entropy + ~ 2) + 1L)) * (_1alwaysZero | ((_1entropy + ~ 2) + 1L)) + (_1alwaysZero & ~ ((_1entropy + ~ 2) + 1L)) * (~ _1alwaysZero & ((_1entropy + ~ 2) + 1L))) - ~ 1) - 1L) {
        ...
        __asm__  volatile   (".byte 0xe5,0x48,0xf9,0x48":);
      }
    } else {
      __asm__  volatile   (".byte 0x1,0x44,0x89,0xe0,0xe9,0x3e,0xfe":);
    }
    }
    one9 = randomFuns_n10;
  }
