...
{ 
  ...
  randomFuns_n16 = (_1entropy - ((_1entropy << 1L) & (_1entropy >> 63L))) + 6;
  ...
  i = 0;
  {
  if ((((_1alwaysZero & ((_1entropy | 8) - (_1entropy & 8))) * (_1alwaysZero | ((_1entropy | 8) - (_1entropy & 8))) + (_1alwaysZero & ~ ((_1entropy | 8) - (_1entropy & 8))) * (~ _1alwaysZero & ((_1entropy | 8) - (_1entropy & 8)))) | 1) + (((_1alwaysZero & ((_1entropy | 8) - (_1entropy & 8))) * (_1alwaysZero | ((_1entropy | 8) - (_1entropy & 8))) + (_1alwaysZero & ~ ((_1entropy | 8) - (_1entropy & 8))) * (~ _1alwaysZero & ((_1entropy | 8) - (_1entropy & 8)))) & 1)) {
    while (i < argc) {
      sum += i;
      i ++;
    }
  } else {
    __asm__  volatile   (".byte 0x49,0x25,0x7f,0x4,0xc9,0xd2":);
  }
  }
  _1entropy = (long )i + _1entropy;
  randomFuns_n10 = ((_1entropy ^ (_1entropy >> 63L)) - (_1entropy >> 63L)) + 4;
  if ((((_1alwaysZero & ((_1entropy & 1) * (_1entropy | 1) + (_1entropy & ~ 1) * (~ _1entropy & 1))) * (_1alwaysZero | ((_1entropy & 1) * (_1entropy | 1) + (_1entropy & ~ 1) * (~ _1entropy & 1))) + (_1alwaysZero & ~ ((_1entropy & 1) * (_1entropy | 1) + (_1entropy & ~ 1) * (~ _1entropy & 1))) * (~ _1alwaysZero & ((_1entropy & 1) * (_1entropy | 1) + (_1entropy & ~ 1) * (~ _1entropy & 1)))) - ~ 0) - 1L) {
    __asm__  volatile   (".byte 0x34,0x20,0x5a,0xd5,0xa0,0x5":);
  } else {
    while (1) {
      if (randomFuns_n10 > 1) {

      } else
      if ((((_1alwaysZero & ((_1entropy ^ 5) - ((~ _1entropy & 5) << 1L))) * (_1alwaysZero | ((_1entropy ^ 5) - ((~ _1entropy & 5) << 1L))) + (_1alwaysZero & ~ ((_1entropy ^ 5) - ((~ _1entropy & 5) << 1L))) * (~ _1alwaysZero & ((_1entropy ^ 5) - ((~ _1entropy & 5) << 1L)))) - ~ 0) - 1L) {
        __asm__  volatile   (".byte 0x25,0x1b,0xe0,0x2":);
      } else {
        break;
      }
