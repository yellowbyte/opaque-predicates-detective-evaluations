...
{ 
  ...
  randomFuns_n10 = (_1entropy - ((_1entropy + _1entropy) & (_1entropy >> 63L))) + 1;
  if ((((_1alwaysZero & (((_1entropy & ~ 1) << 1L) - (_1entropy ^ 1))) * (_1alwaysZero | (((_1entropy & ~ 1) << 1L) - (_1entropy ^ 1))) + (_1alwaysZero & ~ (((_1entropy & ~ 1) << 1L) - (_1entropy ^ 1))) * (~ _1alwaysZero & (((_1entropy & ~ 1) << 1L) - (_1entropy ^ 1)))) | 0) + (((_1alwaysZero & (((_1entropy & ~ 1) << 1L) - (_1entropy ^ 1))) * (_1alwaysZero | (((_1entropy & ~ 1) << 1L) - (_1entropy ^ 1))) + (_1alwaysZero & ~ (((_1entropy & ~ 1) << 1L) - (_1entropy ^ 1))) * (~ _1alwaysZero & (((_1entropy & ~ 1) << 1L) - (_1entropy ^ 1)))) & 0)) {
    __asm__  volatile   (".byte 0x8,0xf4":);
  } else
  if (((((_1alwaysZero & (((_1entropy + 10) + 1L) + ((- _1entropy - 1L) | (- 10 - 1L)))) * (_1alwaysZero | (((_1entropy + 10) + 1L) + ((- _1entropy - 1L) | (- 10 - 1L)))) + (_1alwaysZero & ~ (((_1entropy + 10) + 1L) + ((- _1entropy - 1L) | (- 10 - 1L)))) * (~ _1alwaysZero & (((_1entropy + 10) + 1L) + ((- _1entropy - 1L) | (- 10 - 1L))))) ^ ~ 1) + ((((_1alwaysZero & (((_1entropy + 10) + 1L) + ((- _1entropy - 1L) | (- 10 - 1L)))) * (_1alwaysZero | (((_1entropy + 10) + 1L) + ((- _1entropy - 1L) | (- 10 - 1L)))) + (_1alwaysZero & ~ (((_1entropy + 10) + 1L) + ((- _1entropy - 1L) | (- 10 - 1L)))) * (~ _1alwaysZero & (((_1entropy + 10) + 1L) + ((- _1entropy - 1L) | (- 10 - 1L))))) | 1) << 1L)) + 1L) {
    ...
    __asm__  volatile   (".byte 0x6d,0xa5,0xbf,0xc3,0x45":);
  }
  _1alwaysZero = one9 / 2;
  _1entropy = (long )sum + _1entropy;
  randomFuns_n13 = ((_1entropy + (_1entropy >> 63L)) ^ (_1entropy >> 63L)) + 1;
  while (randomFuns_n13 > 1) {
    if (randomFuns_n13 % 2 == 1) {
      {
      if ((((_1alwaysZero & (((_1entropy + 8) + 1L) + ((- _1entropy - 1L) | (- 8 - 1L)))) * (_1alwaysZero | (((_1entropy + 8) + 1L) + ((- _1entropy - 1L) | (- 8 - 1L)))) + (_1alwaysZero & ~ (((_1entropy + 8) + 1L) + ((- _1entropy - 1L) | (- 8 - 1L)))) * (~ _1alwaysZero & (((_1entropy + 8) + 1L) + ((- _1entropy - 1L) | (- 8 - 1L))))) | 1) + (((_1alwaysZero & (((_1entropy + 8) + 1L) + ((- _1entropy - 1L) | (- 8 - 1L)))) * (_1alwaysZero | (((_1entropy + 8) + 1L) + ((- _1entropy - 1L) | (- 8 - 1L)))) + (_1alwaysZero & ~ (((_1entropy + 8) + 1L) + ((- _1entropy - 1L) | (- 8 - 1L)))) * (~ _1alwaysZero & (((_1entropy + 8) + 1L) + ((- _1entropy - 1L) | (- 8 - 1L))))) & 1)) {
        randomFuns_n13 = 3 * randomFuns_n13 + 1;
      } else {
        __asm__  volatile   (".byte 0x9d":);
      }
      }
    } else {
      randomFuns_n13 /= 2;
