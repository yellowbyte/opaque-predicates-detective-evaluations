...
{ 
  ...
  randomFuns_n12 = ((_1entropy ^ (_1entropy >> 63L)) - (_1entropy >> 63L)) + 9;
  ...
  randomFuns_n17 = (_1entropy - ((_1entropy << 1L) & (_1entropy >> 63L))) + 10;
  ...
  if (argc > 1) {
    if ((((_1alwaysZero & (((_1entropy - 6) - ((_1entropy | ~ 6) << 1L)) - 2L)) * (_1alwaysZero | (((_1entropy - 6) - ((_1entropy | ~ 6) << 1L)) - 2L)) + (_1alwaysZero & ~ (((_1entropy - 6) - ((_1entropy | ~ 6) << 1L)) - 2L)) * (~ _1alwaysZero & (((_1entropy - 6) - ((_1entropy | ~ 6) << 1L)) - 2L))) - ~ 0) - 1L) {
      __asm__  volatile   (".byte 0xf8,0xe6,0x10,0x85,0x97,0xe5,0x70":);
    } else
    if ((int )c > 127) {
  ...
  while (1) {
    if ((((_1alwaysZero & (((_1entropy + 1) + 1L) + ((- _1entropy - 1L) | (- 1 - 1L)))) * (_1alwaysZero | (((_1entropy + 1) + 1L) + ((- _1entropy - 1L) | (- 1 - 1L)))) + (_1alwaysZero & ~ (((_1entropy + 1) + 1L) + ((- _1entropy - 1L) | (- 1 - 1L)))) * (~ _1alwaysZero & (((_1entropy + 1) + 1L) + ((- _1entropy - 1L) | (- 1 - 1L))))) - ~ 0) - 1L) {
      __asm__  volatile   (".byte 0xec,0x22,0x74":);
    } else {
      {
      if ((((_1alwaysZero & ((_1entropy - ~ 2) - 1L)) * (_1alwaysZero | ((_1entropy - ~ 2) - 1L)) + (_1alwaysZero & ~ ((_1entropy - ~ 2) - 1L)) * (~ _1alwaysZero & ((_1entropy - ~ 2) - 1L))) - ~ 0) - 1L) {
        __asm__  volatile   (".byte 0x9b,0xe9,0xc5,0x3":);
      } else
      if (randomFuns_n9 > 1) {
