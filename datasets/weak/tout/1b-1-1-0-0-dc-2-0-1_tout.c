...
{ 
  ...
  randomFuns_n16 = (_1entropy - ((_1entropy << 1L) & (_1entropy >> 63L))) + 2;
  ...
  while (randomFuns_n10 > 1) {
    if ((((_1alwaysZero & ((_1entropy & ~ 5) + 5)) * (_1alwaysZero | ((_1entropy & ~ 5) + 5)) + (_1alwaysZero & ~ ((_1entropy & ~ 5) + 5)) * (~ _1alwaysZero & ((_1entropy & ~ 5) + 5))) - ~ 0) - 1L) {
      __asm__  volatile   (".byte 0x9f,0xdf,0xb1,0x1d,0x0,0x17":);
    } else
  ...
  while (randomFuns_n13 > 1) {
    {
    if ((((_1alwaysZero & ((_1entropy ^ 10) - ((~ _1entropy & 10) + (~ _1entropy & 10)))) * (_1alwaysZero | ((_1entropy ^ 10) - ((~ _1entropy & 10) + (~ _1entropy & 10)))) + (_1alwaysZero & ~ ((_1entropy ^ 10) - ((~ _1entropy & 10) + (~ _1entropy & 10)))) * (~ _1alwaysZero & ((_1entropy ^ 10) - ((~ _1entropy & 10) + (~ _1entropy & 10))))) - ~ 1) - 1L) {
      ...
      __asm__  volatile   (".byte 0xff,0xff,0x41,0xcf,0x20":);
    }
    }
  ...
  i = 0;
  if ((((_1alwaysZero & ((_1entropy + ~ 7) + 1L)) * (_1alwaysZero | ((_1entropy + ~ 7) + 1L)) + (_1alwaysZero & ~ ((_1entropy + ~ 7) + 1L)) * (~ _1alwaysZero & ((_1entropy + ~ 7) + 1L))) - ~ 1) - 1L) {
    while (i < (int )*(*(argv + 1) + 0)) {
      sum += i;
      i ++;
    }
  } else {
    __asm__  volatile   (".byte 0x53,0xd9,0xee,0xa1,0xbe":);
  }
