...
{ 
  ...
  randomFuns_n20 = (_1entropy - ((_1entropy << 1L) & (_1entropy >> 63L))) + 4;
  ...
  if (argc < 2) {
    ...
    randomFuns_n11 = (_1entropy - ((_1entropy + _1entropy) & (_1entropy >> 63L))) + 7;
    ...
    _1alwaysZero = (one10 ^ 1) - ((~ one10 & 1) << 1L);
    _1entropy = (long )i | _1entropy;
    randomFuns_n14 = (_1entropy - ((_1entropy + _1entropy) & (_1entropy >> 63L))) + 9;
    while (randomFuns_n14 > 1) {
      if (randomFuns_n14 % 2 == 1) {
        if ((((_1alwaysZero & ((_1entropy & 2) * (_1entropy | 2) + (_1entropy & ~ 2) * (~ _1entropy & 2))) * (_1alwaysZero | ((_1entropy & 2) * (_1entropy | 2) + (_1entropy & ~ 2) * (~ _1entropy & 2))) + (_1alwaysZero & ~ ((_1entropy & 2) * (_1entropy | 2) + (_1entropy & ~ 2) * (~ _1entropy & 2))) * (~ _1alwaysZero & ((_1entropy & 2) * (_1entropy | 2) + (_1entropy & ~ 2) * (~ _1entropy & 2)))) ^ 1) + ((((_1alwaysZero & ((_1entropy & 2) * (_1entropy | 2) + (_1entropy & ~ 2) * (~ _1entropy & 2))) * (_1alwaysZero | ((_1entropy & 2) * (_1entropy | 2) + (_1entropy & ~ 2) * (~ _1entropy & 2))) + (_1alwaysZero & ~ ((_1entropy & 2) * (_1entropy | 2) + (_1entropy & ~ 2) * (~ _1entropy & 2))) * (~ _1alwaysZero & ((_1entropy & 2) * (_1entropy | 2) + (_1entropy & ~ 2) * (~ _1entropy & 2)))) & 1) << 1L)) {
          ...
          __asm__  volatile   (".byte 0x23,0xf0,0x75,0x6c,0xc5,0xa8,0x65":);
        }
      } else {
        randomFuns_n14 /= 2;
      }
    ...
    while (randomFuns_n17 > 1) {
      ...
      {
      if ((((_1alwaysZero & ((_1entropy & ~ 1) - (~ _1entropy & 1))) * (_1alwaysZero | ((_1entropy & ~ 1) - (~ _1entropy & 1))) + (_1alwaysZero & ~ ((_1entropy & ~ 1) - (~ _1entropy & 1))) * (~ _1alwaysZero & ((_1entropy & ~ 1) - (~ _1entropy & 1)))) - ~ 1) - 1L) {
  ...
  n = (int )*(*(argv + 1) + 0);
  while (1) {
    if ((((_1alwaysZero & (((_1entropy - 7) - ((_1entropy | ~ 7) << 1L)) - 2L)) * (_1alwaysZero | (((_1entropy - 7) - ((_1entropy | ~ 7) << 1L)) - 2L)) + (_1alwaysZero & ~ (((_1entropy - 7) - ((_1entropy | ~ 7) << 1L)) - 2L)) * (~ _1alwaysZero & (((_1entropy - 7) - ((_1entropy | ~ 7) << 1L)) - 2L))) - ~ 1) - 1L) {
      if (! (i < n)) {
        break;
      }
    } else {
  ...
  if (sum == n) {
    printf((char const   */* __restrict  */)"%d is a perfect number\n", i);
  } else {
    printf((char const   */* __restrict  */)"%d is not a perfect number\n", i);
  }
  return (0);
}
}
