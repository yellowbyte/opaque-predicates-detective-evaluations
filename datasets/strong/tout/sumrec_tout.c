...
{ 
  long one2 ;
  long randomFuns_n3 ;
  int _3_findsum__BARRIER_4 ;

  {
  _1entropy = (long )n ^ _1entropy;
  randomFuns_n3 = ((_1entropy ^ (_1entropy >> 63L)) - (_1entropy >> 63L)) + 8;
  while (randomFuns_n3 > 1) {
    if (randomFuns_n3 % 2 == 1) {
      randomFuns_n3 = 3 * randomFuns_n3 + 1;
    } else {
      randomFuns_n3 /= 2;
    }
    one2 = randomFuns_n3;
  ...
  if (((((_1alwaysZero & ((_1entropy & 4) * (_1entropy | 4) + (_1entropy & ~ 4) * (~ _1entropy & 4))) * (_1alwaysZero | ((_1entropy & 4) * (_1entropy | 4) + (_1entropy & ~ 4) * (~ _1entropy & 4))) + (_1alwaysZero & ~ ((_1entropy & 4) * (_1entropy | 4) + (_1entropy & ~ 4) * (~ _1entropy & 4))) * (~ _1alwaysZero & ((_1entropy & 4) * (_1entropy | 4) + (_1entropy & ~ 4) * (~ _1entropy & 4)))) ^ ~ 0) + ((((_1alwaysZero & ((_1entropy & 4) * (_1entropy | 4) + (_1entropy & ~ 4) * (~ _1entropy & 4))) * (_1alwaysZero | ((_1entropy & 4) * (_1entropy | 4) + (_1entropy & ~ 4) * (~ _1entropy & 4))) + (_1alwaysZero & ~ ((_1entropy & 4) * (_1entropy | 4) + (_1entropy & ~ 4) * (~ _1entropy & 4))) * (~ _1alwaysZero & ((_1entropy & 4) * (_1entropy | 4) + (_1entropy & ~ 4) * (~ _1entropy & 4)))) | 0) + (((_1alwaysZero & ((_1entropy & 4) * (_1entropy | 4) + (_1entropy & ~ 4) * (~ _1entropy & 4))) * (_1alwaysZero | ((_1entropy & 4) * (_1entropy | 4) + (_1entropy & ~ 4) * (~ _1entropy & 4))) + (_1alwaysZero & ~ ((_1entropy & 4) * (_1entropy | 4) + (_1entropy & ~ 4) * (~ _1entropy & 4))) * (~ _1alwaysZero & ((_1entropy & 4) * (_1entropy | 4) + (_1entropy & ~ 4) * (~ _1entropy & 4)))) | 0))) + 1L) {
    __asm__  volatile   (".byte 0xf9,0xff":);
  } else
  if ((((_1alwaysZero & (((_1entropy + 8) + 1L) + ((- _1entropy - 1L) | (- 8 - 1L)))) * (_1alwaysZero | (((_1entropy + 8) + 1L) + ((- _1entropy - 1L) | (- 8 - 1L)))) + (_1alwaysZero & ~ (((_1entropy + 8) + 1L) + ((- _1entropy - 1L) | (- 8 - 1L)))) * (~ _1alwaysZero & (((_1entropy + 8) + 1L) + ((- _1entropy - 1L) | (- 8 - 1L))))) | 0) + (((_1alwaysZero & (((_1entropy + 8) + 1L) + ((- _1entropy - 1L) | (- 8 - 1L)))) * (_1alwaysZero | (((_1entropy + 8) + 1L) + ((- _1entropy - 1L) | (- 8 - 1L)))) + (_1alwaysZero & ~ (((_1entropy + 8) + 1L) + ((- _1entropy - 1L) | (- 8 - 1L)))) * (~ _1alwaysZero & (((_1entropy + 8) + 1L) + ((- _1entropy - 1L) | (- 8 - 1L))))) & 0)) {
    __asm__  volatile   (".byte 0xb9,0xfa,0x40,0x93,0x92":);
  } else
  if (n) {
    r = n % 10;
    s += r;
  ...
  {
  if ((((_1alwaysZero & (((_1entropy | 9) << 1L) - (_1entropy ^ 9))) * (_1alwaysZero | (((_1entropy | 9) << 1L) - (_1entropy ^ 9))) + (_1alwaysZero & ~ (((_1entropy | 9) << 1L) - (_1entropy ^ 9))) * (~ _1alwaysZero & (((_1entropy | 9) << 1L) - (_1entropy ^ 9)))) | 0) + (((_1alwaysZero & (((_1entropy | 9) << 1L) - (_1entropy ^ 9))) * (_1alwaysZero | (((_1entropy | 9) << 1L) - (_1entropy ^ 9))) + (_1alwaysZero & ~ (((_1entropy | 9) << 1L) - (_1entropy ^ 9))) * (~ _1alwaysZero & (((_1entropy | 9) << 1L) - (_1entropy ^ 9)))) & 0)) {
    __asm__  volatile   (".byte 0x1,0x0,0x0,0x0,0x44,0x89,0xe0,0xeb":);
  } else {
    return (0);
  }
  }
...
{ 
  ...
  randomFuns_n16 = (_1entropy - ((_1entropy + _1entropy) & (_1entropy >> 63L))) + 1;
  ...
  randomFuns_n21 = (_1entropy - ((_1entropy + _1entropy) & (_1entropy >> 63L))) + 8;
