...
{ 
  ...
  randomFuns_n16 = (_1entropy - ((_1entropy + _1entropy) & (_1entropy >> 63L))) + 9;
  ...
  randomFuns_n21 = (_1entropy - ((_1entropy << 1L) & (_1entropy >> 63L))) + 6;
...
{ 
  ...
  long one5 ;
  long randomFuns_n6 ;
  int _3_fact__BARRIER_4 ;

  {
  _1entropy = (long )n + _1entropy;
  randomFuns_n6 = ((_1entropy ^ (_1entropy >> 63L)) - (_1entropy >> 63L)) + 3;
  while (randomFuns_n6 > 1) {
  ...
  _1alwaysZero = one5 / 2;
  _3_fact__BARRIER_4 = 1;

  if (n == 1) {
    _1entropy = (long )tmp ^ _1entropy;
    randomFuns_n4 = (_1entropy - ((_1entropy << 1L) & (_1entropy >> 63L))) + 7;
    while (1) {
      {
      if ((((_1alwaysZero & ((_1entropy | 6) - (_1entropy & 6))) * (_1alwaysZero | ((_1entropy | 6) - (_1entropy & 6))) + (_1alwaysZero & ~ ((_1entropy | 6) - (_1entropy & 6))) * (~ _1alwaysZero & ((_1entropy | 6) - (_1entropy & 6)))) - ~ 1) - 1L) {
        ...
        __asm__  volatile   (".byte 0x3e,0x7b,0x2c,0xf9,0x35,0x87,0xf9,0x2e":);
      }
      }
      if (randomFuns_n4 % 2 == 1) {
        randomFuns_n4 = 3 * randomFuns_n4 + 1;
      } else {
        randomFuns_n4 /= 2;
      }
      one3 = randomFuns_n4;
    }
    if ((((_1alwaysZero & ((_1entropy & ~ 10) + 10)) * (_1alwaysZero | ((_1entropy & ~ 10) + 10)) + (_1alwaysZero & ~ ((_1entropy & ~ 10) + 10)) * (~ _1alwaysZero & ((_1entropy & ~ 10) + 10))) - ~ 0) - 1L) {
      __asm__  volatile   (".byte 0x0,0x0":);
    } else {
      _1alwaysZero = ((one3 & ~ 1) + (one3 & ~ 1)) - (one3 ^ 1);
    }
    return (1);
  } else {
    tmp = fact(n - 1);
    if ((((_1alwaysZero & ((_1entropy + ~ 5) + 1L)) * (_1alwaysZero | ((_1entropy + ~ 5) + 1L)) + (_1alwaysZero & ~ ((_1entropy + ~ 5) + 1L)) * (~ _1alwaysZero & ((_1entropy + ~ 5) + 1L))) ^ 0) + ((((_1alwaysZero & ((_1entropy + ~ 5) + 1L)) * (_1alwaysZero | ((_1entropy + ~ 5) + 1L)) + (_1alwaysZero & ~ ((_1entropy + ~ 5) + 1L)) * (~ _1alwaysZero & ((_1entropy + ~ 5) + 1L))) & 0) << 1L)) {
      __asm__  volatile   (".byte 0x55,0x50,0x83,0x6":);
    } else {
      return (n * tmp);
    }
  }
